...
Converts bash setup script to interactive Python
"""
...
BASE_PACKAGES = [
    "pandas", "requests", "beautifulsoup4", "tqdm", "psutil", 
    "numpy", "openpyxl", "xlsxwriter", "flask", "pydrive2", 
    "waitress", "gunicorn", "matplotlib"
]

ML_PACKAGES = [
    "scikit-learn", "datasets", "transformers==4.48.1", 
    "accelerate==1.3.0", "peft==0.14.0", "trl", "IPython", 
    "ipywidgets", "ipykernel", "bitsandbytes"
]
...
def show_menu():
    ...
    print("  6. Check current installation")
    print("  7. Exit")
    print("-"*60)
...
def check_installation():
    ...
    packages_to_check = ["torch", "pandas", "transformers", "sklearn"]
