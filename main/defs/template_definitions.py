...
result_phrases = {
    "IR": [
        ...
        "resulting in a {gain_loss} in interest expense of {currency_code}{amount} {money_unit}",
        ...
        "{financial_outcome_verb} interest income (expense) of {currency_code}{amount} {money_unit} related to these {swap_type}",
        "to cap or fix {company}'s {ir_term} at {pct}% on an agreed upon principal amount of {currency_code}{amount} {money_unit}",
    ...
    "FX": [
        ...
        "with translation {gain_loss} of {currency_code}{amount} {money_unit} {outcome_location}",
    ...
    "GEN": [
        "resulting in {currency_code}{amount} {money_unit} of unrealized {gain_loss} {outcome_location}",
