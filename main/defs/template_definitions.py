...
result_phrases = {
    "IR": [
        ...
        "{mitigation_verb_ing} the potential impact of {gain_loss} in {ir_term} on its interest-bearing {debt_type}",
        ...
        "{mitigation_verb_ing} against the possible negative effects of {ir_term} {risk_term} on {debt_type} obligations",
        ...
        "{mitigation_verb_ing} its {ir_term} and cash flow {risk_term} associated with its {debt_type}",
    ...
    "FX": [
        ...
        "{mitigation_verb_ing} foreign currency translation adjustments",
        "{mitigation_verb_ing} {currencies} exchange rate {risk_term} on foreign currency denominated transactions",
        ...
        "{mitigation_verb_ing} exposure to foreign currency {risk_term} in {currencies}",
        "hedging foreign-denominated cash flows",
        "which {mitigation_verb} foreign exchange {risk_term} against {currencies}",
        "{mitigation_verb_ing} foreign exchange {risk_term} against {currencies}",
    ...
    "CP": [
        ...
        "{mitigation_verb_ing} {commodity} price {risk_term}",
        "{mitigation_verb_ing} {risk_term} to volatile {commodity} prices",
        "{mitigation_verb_ing} cost of goods sold despite {commodity} price {risk_term}",
        "{mitigation_verb_ing} against {gain_loss} in {commodity} costs",
        ...
        "{mitigation_verb_ing} exposure to {commodity} price {risk_term}",
        "{mitigation_verb_ing} {commodity} costs",
    ...
    "EQ": [
        ...
        "{mitigation_verb_ing} market value changes in the underlying equity positions",
        "{mitigation_verb_ing} exposure to equity market {risk_term}",
        "{mitigation_verb_ing} {gain_loss} on equity investments",
...
MITIGATION_TEMPLATES = {
    ...
    "EQ": [
        "to {risk_action_verb} {risk_term} to {risk_term2} in the market price of its common stock and related equity-based compensation costs",
        "to {risk_action_verb} {risk_term} in compensation expense associated with {risk_term2} in share price",
        "to {risk_action_verb} {risk_term} to equity price {risk_term2}",
        "to {risk_action_verb} market {risk_term}s associated with {risk_term2} in stock price",
        "to {risk_action_verb} potential {risk_term} from changes in share price",
        "to {risk_action_verb} {risk_term} in reported expenses arising from equity-linked compensation",
        "as economic hedges of share price {risk_term}",
        ...
        "to {risk_action_verb} {risk_term} in equity valuation",
        "to {risk_action_verb} {risk_term} to its common stock value",
    ...
    "GEN": [
        ...
        "to {risk_action_verb} {risk_term}s in accordance with the company's hedging policy",
        "to {risk_action_verb} {risk_term} to broad market {risk_term2}",
