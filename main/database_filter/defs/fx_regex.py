...
def run_tests():
    ...
    test_cases = [
        ...
        ("Forward rate agreement", MatchLevel.NONE),
        ("forward rate contract", MatchLevel.STRICT),
        ("forward rate option", MatchLevel.STRICT),
        ("foreign exchange contract", MatchLevel.STRICT),
        ...
        ("currency derivative", MatchLevel.STRICT),
        ...
        ("currency rate forward", MatchLevel.STRICT),
        ("forward foreign exchange", MatchLevel.NONE),
        ("foreign exchange futures", MatchLevel.STRICT),
        ("foreign exchange rate futures", MatchLevel.STRICT),
        ("currency futures", MatchLevel.STRICT),
        ("currency rate futures", MatchLevel.STRICT),
        ...
        ("foreign exchange rate option", MatchLevel.STRICT),
        ("currency option", MatchLevel.STRICT),
        ("currency rate option", MatchLevel.STRICT),
        ("foreign exchange cap", MatchLevel.STRICT),
        ("foreign exchange rate cap", MatchLevel.STRICT),
        ("currency cap", MatchLevel.STRICT),
        ("currency rate cap", MatchLevel.STRICT),
        ("foreign exchange floor", MatchLevel.STRICT),
        ("foreign exchange rate floor", MatchLevel.STRICT),
        ("currency floor", MatchLevel.STRICT),
        ("currency rate floor", MatchLevel.STRICT),
