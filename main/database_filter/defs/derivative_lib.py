...
from defs.cp_regex import COMMODITY_REGEX, CP_CONTEXT_REGEX, CP_REGEX, CP_SOFT_REGEX, CP_STRICT_CONTEXT_REGEX, CP_LOOSE_REGEX, CP_RISK_REGEX, COMMON_COMMODITIES
...
from defs.gen_regex import GEN_REGEX, NOTIONAL_REGEX, HEDGING_CONTEXT_REGEX, GEN_STRICT_CONTEXT_REGEX, PRECISE_LOOSE_GEN_REGEX
