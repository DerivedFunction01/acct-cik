Your task is to act as an expert financial analyst. Analyze the following text from an SEC filing and write a concise, natural-language summary explaining what derivative instruments the company is using and for what purpose.
...
1.  **Begin with Reasoning:** Start your response with a `<|think|>` block. Inside this block, provide a step-by-step "chain of thought" that explains how you arrived at your summary.
    ...
    *   Next, identify the specific derivative instruments used to manage those risks (e.g., swaps, forwards).
    *   Note any details like notional amounts or whether the activity is current or historical.
...
---
Now, analyze the following text and generate your response.
