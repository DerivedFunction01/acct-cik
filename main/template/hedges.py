...
ir_specific_mitigation = [
    ...
    "to convert fixed-rate {debt_type} to variable rates",
    "to manage interest rate and credit risk on {debt_type}",
    "to adjust the interest rate profile of its {debt_type}",
    "to hedge changes in the fair value of fixed-rate liabilities",
    "to manage exposure to interest rate fluctuations",
    "to modify the interest rate structure of its {debt_type}",
    "to hedge the fair value of outstanding {debt_type}",
    "to manage interest rate exposure on {debt_type}",
    "to adjust the interest rate characteristics of long-term liabilities",
    "to mitigate interest rate risk on {debt_type} issuances",
    "to manage debt-related interest rate risk",
    "to hedge fixed-rate {debt_type} obligations",
    "to optimize the interest rate profile of its debt portfolio, converting portions of fixed-rate {debt_type} to floating-rate instruments",
    "to adjust the effective interest rate composition of outstanding {debt_type}",
    "to reduce interest rate volatility on its {debt_type} obligations",
    "to transform fixed-rate debt into variable-rate {debt_type} where appropriate",
    ...
    "to convert portions of {debt_type} into instruments with more favorable interest rate terms",
    ...
    "to protect against unfavorable changes in {debt_type} obligations",
    "to hedge interest rate risk on forecasted {debt_type} issuances",
    "to hedge against changes in interest rates that could impact expected future issuances of {debt_type}",
    ...
    "to mitigate the risk of rising interest rates on planned fixed-rate {debt_type} issuances",
    "to secure interest rates for future {debt_type} issuances",
    "to manage interest rate risk",
    "to protect against interest rate volatility for planned fixed-rate {debt_type} issuances",
    "to lock in rates for anticipated d{debt_type}ebt financings",
    "to stabilize future interest costs",
    "to mitigate interest rate fluctuations on planned debt offerings",
    "to secure rates for future fixed-rate {debt_type}",
    "to manage interest rate exposure for anticipated debt issuances",
    "to lock in rates prior to {debt_type} financings",
    "to hedge against rising interest rates for planned {debt_type} issuances",
    "to stabilize interest rates for forecasted {debt_type} issuances",
    "to manage risk on future {debt_type} offerings",
    "to secure favorable rates for anticipated fixed-rate {debt_type}",
    ...
    "to manage interest costs by using a mix of fixed- and floating-rate {debt_type}",
    ...
    "to specifically reduce exposure to interest rate and credit risk",
]
...
DEFAULT_SUFFIXES = ["", "agreement", "contract", "arrangement", "instrument", "transaction", "commitment", "position", "program"]
