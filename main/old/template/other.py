...
sec_phrases = [
    ...
    "required to be filed by Section 13 or Section 15(d) of the Securities Exchange Act of 1934",
    "during the preceding 12 months (or for such shorter period that the registrant was required to file such reports)",
    "and (2) has been subject to such filing requirements for the past 90 days. Yes {choice1} No {choice2}",
    ...
    "posted to Rule 405 of Regulations S-T (§232.405 of this chapter)",
    "during the preceding 12 months (or for such shorter period that the registrant was required to submit and post such files). Yes {choice1} No {choice2}",
    'Indicate by check mark whether the registrant is a large accelerated filer, an accelerated filer, a non-accelerated filer, or a smaller reporting company.', 
    'See the definitions of "large accelerated filer," "accelerated filer" and "smaller reporting company" in Rule 12b-2 of the Exchange Act Yes {choice1} No {choice2}',
    ...
    "Part III incorporates certain information by reference from the registrant's proxy statement for the {year}",
    "Annual Meeting of Shareholders expected to be held on {month} {day}, {next_year}.",
    "Such proxy statement will be filed no later than 120 days after the close of the registrant's fiscal year ended {month} {day2},  {year}.",
]
...
debt_templates = [
    ...
    "{company}'s {debt_type} which is subject to a floating rate of interest and is not hedged by {swap_type} is valued at {currency_code}{amount} {money_unit} at {month} {end_day}, {year}",
]
...
stock_option_plan_templates = [
    ...
    "{company} maintains the {year} Stock Option Plan, under which {shares} shares of common stock are reserved for issuance to employees, officers, directors, and consultants.",
