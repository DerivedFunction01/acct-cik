...
# =============================================================================
# LOAD CONFIGURATION FROM run_server.py
# =============================================================================

CONFIG_FILE = ".server_config.json"

def load_num_threads_from_config():
    """
    Reads the number of threads from .server_config.json, which is generated by run_server.py.
    ...
    if not Path(CONFIG_FILE).exists():
        ...
        print(f"   Run 'python run_server.py start' first to generate it.")
        print(f"   Using default: NUM_THREADS = {default_threads}")
    ...
    try:
        ...
        num_threads = config.get("num_threads_per_process", default_threads)
        num_processes = config.get("num_processes", 1)

        print(
            f"✅ Loaded config: {num_processes} server processes, {num_threads} threads per process"
        )
        return num_threads
...
def get_system_config():
    ...
    # Load NUM_THREADS from config file (generated by run_server.py)
    num_threads = load_num_threads_from_config()

    print(
        f"⚙️  Configuration: NUM_THREADS={num_threads}, TEXT_SIZE={text_size}"
    )
    return num_threads, text_size

NUM_THREADS, TEXT_SIZE = get_system_config()
