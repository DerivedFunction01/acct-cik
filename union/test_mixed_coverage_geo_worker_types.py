...
CASES = [
    ...
    (
        "The company has 100 workers in Italy and Argentina including 20 pilots and 10 auto workers belonging to a local union.",
        {"IT", "AR"},
        30.0,
        None,
        100.0,
    ...
    (
        "The company has 100 workers in Germany and Mexico including 20 pilots and 10 auto workers belonging to a local union.",
        {"DE", "MX"},
        30.0,
        None,
        100.0,
    ...
    (
        "The company has 100 workers in France and China including 20 pilots and 10 auto workers belonging to a local union.",
        {"FR", "CN"},
        30.0,
        None,
        100.0,
