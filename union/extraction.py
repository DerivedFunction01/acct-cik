...
EXCLUSIONS = [
    ...
    add_restrictions(r"exclud(?:ing|es?)", lookbehinds=[r"not"]),
    r"not\s+includ(?:ing|es?)",
    r"but",
]
...
QUALITATIVE_ALL_TERMS = [
    ...
    QualitativeTerm(
        core_terms=[r"every(?:[- ]?one)?", r"entire", r"each", r"all"],
    ...
    QualitativeTerm(
        core_terms=WORKER_TERMS,
        suffix_terms=[r"((?:were|are)\s+)all"],
        positive_pct=100.0,
        negated_pct=None,
        requires_suffix=True,
        lower_bound=100.0,
